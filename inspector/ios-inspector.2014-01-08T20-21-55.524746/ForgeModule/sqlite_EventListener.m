...
{
    [ForgeLog d:@"FETCHNOTES: Did finish launching with options"];
    
    if ([launchOptions objectForKey:@"UIApplicationLaunchOptionsRemoteNotificationKey"]) {
        [ForgeLog d:@"FETCHNOTES: Received Push Notification while not running"];
        NSLog(@"FETCHNOTES: launchOptions: %@", [launchOptions objectForKey:UIApplicationLaunchOptionsRemoteNotificationKey]);
        [[ForgeApp sharedApp] event:@"sqlite.pushNotificationReceived" withParam:launchOptions];
    } else {
        [ForgeLog d:@"FETCHNOTES: WEIRD WEIRD WEIRD WEIRD"];
    }
